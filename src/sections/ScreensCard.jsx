...
const ScreensCard = () => {
  ...
  return (
    <>
      <div className="relative flex justify-center overflow-hidden border border-secondary dark:border-darkSecondary group rounded-2xl min-w-[160px] max-w-[260px]">
